export default {
  ...
  electronApp: {
    ...
    hudHint: 'Choose the in-game HUD template. The overlay resizes itself when the template changes.',
    hudClassic: 'Classic',
    hudRacing: 'Racing',
    hudMinimal: 'Minimal',
  ...
  driveStyle: {
    ...
    regime: 'Regime',
    hint:
      'Tracks recent driving demand. Rises fast (~0.3s), falls slow (~6s) for a Tiptronic-style memory.',
  },
  powerBand: {
    title: 'Power Band',
  ...
  settings: {
    ...
    landingRecovery: 'Landing / impact recovery',
    transientLock: 'Transient Lock (oversteer)',
    driveStyle: 'Drive Style',
    ...
    raceCoastRpm: 'Race coast recovery RPM',
    offroadCoastRpm: 'Offroad coast recovery RPM',
    driftUp: 'Drift up',
  ...
  extras: {
    ...
    clutchAssist: 'Clutch assist',
    clutchAssistHint: 'Optionally wraps each keyboard shift with a short clutch key press.',
    clutchKey: 'Clutch key',
    clutchPreMs: 'Pre-press',
    clutchOverlapMs: 'Shift overlap',
    clutchReleaseMs: 'Release delay',
